...
app.get('/agent/install.sh', (c) => c.redirect('https://raw.githubusercontent.com/tuzili/cf-vps-monitor/main/agent/install.sh', 302));
app.get('/agent/install-linux.sh', (c) => c.redirect('https://raw.githubusercontent.com/tuzili/cf-vps-monitor/main/agent/install-linux.sh', 302));
app.get('/agent/install-windows.ps1', (c) => c.redirect('https://raw.githubusercontent.com/tuzili/cf-vps-monitor/main/agent/install-windows.ps1', 302));
